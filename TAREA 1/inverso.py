...
def polo_euler(filename): #ARCHIVO CON LAS ESTACIONES ESTABLES
    ...
    #W NOS DA EL RESULTADO QUE ESTABAMOS BUSCANDO
    ...
    return [euler_pole, pred_n, pred_e]
    
[polo,vn_pred, ve_pred] = polo_euler("estacionaria_velo.txt")
print(polo) #SOLO DA EL RESULTADO, NO LO GUARDA EN NINGUN LADO
